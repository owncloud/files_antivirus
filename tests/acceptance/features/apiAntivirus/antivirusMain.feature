...
Feature: Antivirus basic
	...
	Scenario: A small file without a virus can be uploaded in chunks using API version 1 and new DAV path
		Given using API version "1"
	...
	Scenario: A small file with a virus cannot be uploaded in chunks using API version 1 and new DAV path
		Given using API version "1"
		And using new DAV path
		When user "user0" creates a new chunking upload with id "chunking-42" using the API
	...
	Scenario: A small file without a virus can be uploaded in chunks using API version 2 and new DAV path
	...
	Scenario: A small file with a virus cannot be uploaded in chunks using API version 2 and new DAV path
		Given using API version "2"
		And using new DAV path
		When user "user0" creates a new chunking upload with id "chunking-42" using the API
		And user "user0" uploads new chunk file "1" with "This kitten " to id "chunking-42" using the API
